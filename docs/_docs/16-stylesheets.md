...
```scss
/* type scale */
$type-size-1 : 2.6em;  // ~39.056px
$type-size-2 : 2.4em;  // ~31.248px
$type-size-3 : 2.2em;  // ~25.008px
$type-size-4 : 2em;   // ~20px
$type-size-5 : 1.8em;      // ~16px
$type-size-6 : 1.6em;   // ~12px
$type-size-7 : 1.4em; // ~11px
$type-size-8 : 1.2em;  // ~10px
```
